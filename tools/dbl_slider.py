...
class Head(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, str(
            numpy.round(self.main.min(), 2)))
...
class Tail(Element):
    ...
    def drawText(self, event, qp):
        qp.setPen(self.textColor())
        qp.setFont(QtGui.QFont('Arial', 10))
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, str(
            numpy.round(self.main.max(), 2)))
...
class Handle(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.setFont(QtGui.QFont('Arial', 10))
        qp.drawText(event.rect(), QtCore.Qt.AlignLeft, str(
            numpy.round(self.main.start(), 2)))
        qp.drawText(event.rect(), QtCore.Qt.AlignRight, str(
            numpy.round(self.main.end(), 2)))
